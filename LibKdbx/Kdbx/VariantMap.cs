...
/// </summary>
public class VariantMap(Dictionary<string, object> data)
{
    ...
    public byte[] Serialize()
    {
        ...
        foreach ((string key, object value) in _data)
        {
            byte type;
            byte[] val;
            ...
            switch (value)
            {
                case uint u:
                    type = 0x04;
                    val = new byte[4];
                    BinaryPrimitives.WriteUInt32LittleEndian(val, u);
                    break;
                case ulong ul:
                    type = 0x05;
                    val = new byte[8];
                    BinaryPrimitives.WriteUInt64LittleEndian(val, ul);
                    break;
                case bool b:
                    type = 0x08;
                    val = [b ? (byte)1 : (byte)0];
                ...
                case int i:
                    type = 0x0C;
                    val = new byte[4];
                    BinaryPrimitives.WriteInt32LittleEndian(val, i);
                    break;
                case long l:
                    type = 0x0D;
                    val = new byte[8];
                    BinaryPrimitives.WriteInt64LittleEndian(val, l);
                    break;
                case string s:
                    type = 0x18;
    ...
    public string Dump()
    {
        ...
        foreach ((string k, object v) in _data)
        {
